...
class TestRun:
    ...
    @pytest.mark.asyncio
    async def test_run_upserts_to_four_tables(self):
        geo_lookup = _make_geo_lookup()
        loader = _make_loader(geo_lookup)
        ...
        # Should have upserted to vacancy_rates, average_rents, housing_starts, indicator_values
        ...
        assert loader.upsert.call_count >= 3
